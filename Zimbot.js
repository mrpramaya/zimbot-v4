...
const reply = (teks) => {
    ZimBotInc.sendMessage(m.chat, {text: teks, contextInfo: {"externalAdReply": {title: "ZIM BOT V4",mediaType: 3, renderLargerThumbnail: false, showAdAttribution: true, detectLinks: true,body: "DRIPS OFC", thumbnail: fs.readFileSync('./drips.jpg'),sourceUrl: ("https://chat.whatsapp.com/Go9cBxSneUpGDbl6gKdF7E")}}})
}
const replay = (teks) => {
    ZimBotInc.sendMessage(m.chat, {text: teks, contextInfo: {"externalAdReply": {title: "ZIM BOT V4",mediaType: 3, renderLargerThumbnail: false, showAdAttribution: true, body: "DRIPS OFC", thumbnail: fs.readFileSync('./drips.jpg'),sourceUrl: ("https://chat.whatsapp.com/Go9cBxSneUpGDbl6gKdF7E")}}})
}
...
hydratedButtons:  [{        
    "urlButton": {
      ...
      "url": "https://chat.whatsapp.com/Go9cBxSneUpGDbl6gKdF7E"
    }
}, {
quickReplyButton: {
...
setTimeout(function(){
  ZimBotInc.sendMessage(ZimBotInc.user.id, {text: `*ZIM BOT INC ANNOUNCEMENT:* *SUBSCRIBE TO DRIPS OFC*\n\n*YOUTUBE:* https://chat.whatsapp.com/Go9cBxSneUpGDbl6gKdF7E\n\n*NEW FEATURES COMING SOON SO STAY TUNED*\n\n*FEEL FREE TO BRING IDEAS OF THE FEATURES ON THE TABLE*\n\n*IF YOU WANT TO CONTRUBUTE FORK THE REPO, MAKE CHANGES PUSH YOUR CHANGES TO THE ORIGIN BRANCH AND WAIT FOR YOUR PULL REQUEST TO BE VERIFIED*\n\n*Thanks for choosing zim-bot*`,contextInfo: { externalAdReply:{title:"ZIM BOT V4",body:"SUBSCRIBE DRIPS OFC",showAdAttribution: true,mediaType:2,thumbnail: fs.readFileSync(`./drips.jpg`) ,mediaUrl:`https://chat.whatsapp.com/Go9cBxSneUpGDbl6gKdF7E`, sourceUrl: `https://chat.whatsapp.com/Go9cBxSneUpGDbl6gKdF7E` }}}, {quoted: m})
 ...
 */
 ...
 case 'sc': case 'script': case 'donate': case 'donasi': case 'donate': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
  ...
  teks = `
  *ZIM-BOT-V4*\n\n*YOUTUBE:* https://chat.whatsapp.com/Go9cBxSneUpGDbl6gKdF7E\n*GITHUB:* https://chat.whatsapp.com/Go9cBxSneUpGDbl6gKdF7E\n\n*DONATE:* https://www.paypal.com/paypalme/zimbotinc`
  let buttons = [
  ...
  sourceUrl: "https://chat.whatsapp.com/Go9cBxSneUpGDbl6gKdF7Eg"
  }}
  }
  ZimBotInc.sendMessage(m.chat, buttonMessage, { quoted: m })
  }
...
reply(mess.wait)
 ...
 if(!args[0]) throw 'link github  EXAMPLE: https://chat.whatsapp.com/Go9cBxSneUpGDbl6gKdF7E'
if (!regex1.test(args[0])) throw 'link!'
   let [, user, repo] = args[0].match(regex1) || []
    ...
    ZimBotInc.sendMessage(m.chat, { document: { url: url }, fileName: filename+'.zip', mimetype: 'application/zip' , quoted: m,contextInfo: { externalAdReply:{
      ...
      thumbnail: fs.readFileSync('./drips.jpg'),
      mediaUrl:`https://chat.whatsapp.com/Go9cBxSneUpGDbl6gKdF7E`, 
      sourceUrl: `https://chat.whatsapp.com/Go9cBxSneUpGDbl6gKdF7E`,
      }}
      })
 ...
 case 'truth':
        ...
        thumbnail: fs.readFileSync(`./drips.jpg`) ,
        mediaUrl:`https://chat.whatsapp.com/Go9cBxSneUpGDbl6gKdF7E`, 
        sourceUrl: `https://chat.whatsapp.com/Go9cBxSneUpGDbl6gKdF7E` }}}, {quoted: m})
break
case 'ghsearch': 
       case 'githubsearch': 
       case 'searchgithub':
...
%readmore` 
    ...
    const buttonsDefault = [{ urlButton: { displayText: `SUBSCRIBE`, url : `https://chat.whatsapp.com/Go9cBxSneUpGDbl6gKdF7E` } }, { urlButton: { displayText: `GITHUB`, url : `https://chat.whatsapp.com/Go9cBxSneUpGDbl6gKdF7E` } },
    {					
      quickReplyButton: {
      displayText: 'SPEED',
      id: 'ping'
